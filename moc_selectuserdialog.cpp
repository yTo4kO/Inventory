...
**
** Created: Fri Mar 19 23:54:44 2010
...
static const char qt_meta_stringdata_selectuserdialog[] = {
    "selectuserdialog\0\0button\0"
    "on_buttonBox_clicked(QAbstractButton*)\0"
};

const QMetaObject selectuserdialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_selectuserdialog,
      qt_meta_data_selectuserdialog, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &selectuserdialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_selectuserdialog))
        return static_cast<void*>(const_cast< selectuserdialog*>(this));
